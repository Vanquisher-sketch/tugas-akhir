...
return [
    ...
    /*
    |--------------------------------------------------------------------------
    | Custom Validation Attributes (Biar nama kolom di pesan error jadi bagus)
    |--------------------------------------------------------------------------
    */
    'attributes' => [
        'tanah_nama_barang'       => 'Nama Barang',
        'tanah_nomor_register'    => 'Nomor Register',
        'tanah_jumlah'            => 'Jumlah',
        'tanah_satuan'            => 'Satuan',
        'tanah_status_penggunaan' => 'Status Penggunaan',
        'tanah_lokasi_fisik'      => 'Lokasi Fisik',
        'tanah_nilai_perolehan'   => 'Nilai Perolehan',
        'tanah_cara_perolehan'    => 'Cara Perolehan',
        'tanah_tanggal_perolehan' => 'Tanggal Perolehan',
        
        // Bisa ditambahkan untuk KIB lainnya nanti sesuai kebutuhan
