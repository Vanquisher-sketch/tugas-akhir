            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('spesifikasi_barang') is-invalid @enderror" name="spesifikasi_barang" value="{{ old('spesifikasi_barang', $jalan->spesifikasi_barang) }}">
                        @error('spesifikasi_barang') <div class="invalid-feedback">{{ $message }}</div> @enderror
                    </div>

                    <div class="form-group">
                        {{-- Tambahan Sesuai Model: spesifikasi_lainnya --}}
                        <label for="spesifikasi_lainnya">Spesifikasi Lainnya</label>
                        <input type="text" class="form-control @error('spesifikasi_lainnya') is-invalid @enderror" name="spesifikasi_lainnya" value="{{ old('spesifikasi_lainnya', $jalan->spesifikasi_lainnya) }}">
                        @error('spesifikasi_lainnya') <div class="invalid-feedback">{{ $message }}</div> @enderror
                    </div>

                    <div class="form-group">
                        {{-- Sesuai Model: nomor_ruas_jalan_jembatan_irigasi --}}
                        <label for="nomor_ruas_jalan_jembatan_irigasi">Nomor Ruas Jalan/Jembatan/Irigasi</label>
                        <input type="text" class="form-control @error('nomor_ruas_jalan_jembatan_irigasi') is-invalid @enderror" name="nomor_ruas_jalan_jembatan_irigasi" value="{{ old('nomor_ruas_jalan_jembatan_irigasi', $jalan->nomor_ruas_jalan_jembatan_irigasi) }}">
                        @error('nomor_ruas_jalan_jembatan_irigasi') <div class="invalid-feedback">{{ $message }}</div> @enderror
                    </div>

                    <div class="form-group">
                        {{-- Sesuai Model: Lok (Huruf Besar L) --}}
                        <label for="Lok">Lokasi (Alamat)</label>
                        <textarea class="form-control @error('Lok') is-invalid @enderror" name="Lok" rows="2">{{ old('Lok', $jalan->Lok) }}</textarea>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('status_kepemilikan_tanah') is-invalid @enderror" name="status_kepemilikan_tanah" value="{{ old('status_kepemilikan_tanah', $jalan->status_kepemilikan_tanah) }}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" class="form-control @error('tanggal_perolehan') is-invalid @enderror" name="tanggal_perolehan" value="{{ old('tanggal_perolehan', $jalan->tanggal_perolehan ? \Carbon\Carbon::parse($jalan->tanggal_perolehan)->format('Y-m-d') : '') }}">
