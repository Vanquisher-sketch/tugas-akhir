...
<div class="card shadow mb-4">
    ...
    <div class="card-body">
        <form action="{{ route('lokasi.gedung.store', ['lokasi' => $lokasi]) }}" method="POST">
            ...
            {{-- Input Hidden untuk Lokasi (Opsional, jika controller tidak otomatis menangkap dari URL) --}}
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('nbar') is-invalid @enderror" name="nbar" value="{{ old('nbar') }}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control @error('jumlah_lantai') is-invalid @enderror" name="jumlah_lantai" value="{{ old('jumlah_lantai', 1) }}">
                        @error('jumlah_lantai') <div class="invalid-feedback">{{ $message }}</div> @enderror
                    </div>

                    <div class="form-group">
                        <label for="Lok">Lokasi (Alamat)</label>
                        {{-- Perhatikan name="Lok" Huruf Besar sesuai Model --}}
                        <textarea class="form-control @error('Lok') is-invalid @enderror" name="Lok" rows="3">{{ old('Lok') }}</textarea>
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        {{-- DISESUAIKAN: name="jumlah" (bukan jumlah_satuan_tanah) sesuai Model --}}
                        <input type="number" step="0.01" class="form-control @error('jumlah') is-invalid @enderror" name="jumlah" value="{{ old('jumlah') }}" placeholder="Contoh: 100">
                        @error('jumlah') <div class="invalid-feedback">{{ $message }}</div> @enderror
                    </div>

                    <div class="form-group">
                        <label for="satuan">Satuan</label>
                        <input type="text" class="form-control @error('satuan') is-invalid @enderror" name="satuan" value="{{ old('satuan') }}" placeholder="Contoh: M2 / Unit">
