...
<div class="card shadow mb-4">
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-primary">Edit Data Inventaris Tanah (KIB A) - {{ ucfirst($lokasi) }}</h6>
    </div>
    <div class="card-body">
        <form action="{{ route('lokasi.tanah.update', ['lokasi' => $lokasi, 'tanah' => $tanah->id]) }}" method="POST">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    {{-- BARU: Spesifikasi Barang --}}
                    <div class="form-group">
                        <label for="spesifikasi_barang">Spesifikasi Barang</label>
                        <input type="text" class="form-control @error('spesifikasi_barang') is-invalid @enderror" id="spesifikasi_barang" name="spesifikasi_barang" value="{{ old('spesifikasi_barang', $tanah->spesifikasi_barang) }}">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control @error('Lok') is-invalid @enderror" id="Lok" name="Lok" rows="3">{{ old('Lok', $tanah->Lok) }}</textarea>
                    ...
                    {{-- BARU: Nama Bukti --}}
                    <div class="form-group">
                        <label for="bukti_nama">Nama Bukti (Sertifikat/dll)</label>
                        <input type="text" class="form-control @error('bukti_nama') is-invalid @enderror" id="bukti_nama" name="bukti_nama" value="{{ old('bukti_nama', $tanah->bukti_nama) }}">
                    ...
                    {{-- REVISI: name="nama_kepemilikan_dokumen" --}}
                    <div class="form-group">
                        <label for="nama_kepemilikan_dokumen">Nama Kepemilikan</label>
                        <input type="text" class="form-control @error('nama_kepemilikan_dokumen') is-invalid @enderror" id="nama_kepemilikan_dokumen" name="nama_kepemilikan_dokumen" value="{{ old('nama_kepemilikan_dokumen', $tanah->nama_kepemilikan_dokumen) }}">
                ...
                <div class="col-md-6">
                    ...
                    {{-- REVISI: name="status_penggunaan" --}}
                     <div class="form-group">
                        <label for="status_penggunaan">Status</label>
                        <input type="text" class="form-control @error('status_penggunaan') is-invalid @enderror" id="status_penggunaan" name="status_penggunaan" value="{{ old('status_penggunaan', $tanah->status_penggunaan) }}">
